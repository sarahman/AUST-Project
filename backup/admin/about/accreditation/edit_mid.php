<?php
	...
	$sql = mysql_query ("SELECT * FROM page_item WHERE page_id = (select page_id from page_info where page_title = 'accreditation')");
	...
	<div class="container">
		...
		<div class="right">
			<div class="contentDiv">
				<div class="content">
					<form action="content/mid_update.php" method="post">
					<fieldset>
