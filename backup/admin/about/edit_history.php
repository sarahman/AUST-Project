<?php
	...
	$sql = mysql_query ("select item_heading,item_details from page_item where item_no = 2");
	...
	<div class="container">
		...
		<div class="right">
			<div class="contentDiv">
				<div class="content">
					<form action="content/history_update.php" method="post">
					<fieldset>
						<legend>Manage About.php</legend>
								<table border="0">
									<tr>
										...
										<td>
											<i style="color:#993300">History</i>
										</td>
									</tr>
									<tr>
										<td>
										...
										<td>
											<input type="text" name="heading" value="<?php echo $row ['item_heading']; ?>"
										</td>
									</tr>
									<tr>
										<td>
									...
									<tr>
										<td colspan="2">
											<input type="hidden" name="i_no" value="2" />
