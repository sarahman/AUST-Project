<?php
	...
	$sql = mysql_query ("select item_heading,item_details from page_item where item_no = 4");
	...
	<div class="container">
		...
		<div class="right">
			<div class="contentDiv">
				<div class="content">
					<form action="content/objective_update.php" method="post">
					<fieldset>
						<legend>Manage About.php</legend>
								<table border="0">
									...
									<tr>
										<td colspan="2">
											<input type="hidden" name="i_no" value="4" /> 
