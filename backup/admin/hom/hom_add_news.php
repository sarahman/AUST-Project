	...
	<div class="container">
		...
		<div class="right">
			<div class="contentDiv">
				<div class="content">
					<form action="content/add_news.php" method="post" enctype="multipart/form-data">
					<fieldset>
						<legend>Add News</legend>
								<table border="0">
									...
									<tr>
										...
										<td>
											<textarea name="n_details" rows="15">
											</textarea>
										</td>
									</tr>
									<tr>
										...
										<td>
											<input type="text" name="n_date" size="20" value="<?php echo date ("M d") ?>" />
										</td>
									</tr>
									<tr>
										<td>
										...
										<td>
											<input type="text" name="n_time" size="20" value="<?php echo date ("h:i A"); ?>" />
										</td>
									</tr>		
									<tr>
										<td>
										...
										<td>
											<select name="n_type" style="width:100px">
