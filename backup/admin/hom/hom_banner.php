...
?>
<?php
	$sql = mysql_query ("select * from page_item where page_id = '1' and item_heading = 'banner'");
	...
	<div class="container">
		...
		<div class="right">
			<div class="contentDiv">
				<div class="content">
					<form action="content/banner_update.php" method="post">
					<fieldset>
						<legend>Banner</legend>
								<table border="0">
									...
									<tr>
										...
										<td>
											<textarea name="bcontent" rows="15">
												<?php
