	...
	<div class="container">
		...
		<div class="right">
			<div class="contentDiv">
				<div class="content">
					<form action="content/insert_news.php" method="post">
					<fieldset>
						<legend>Add News</legend>
								<table border="0" cellpadding="0" cellspacing="0">
									...
									<tr>
										...
										<td>
											<textarea name="n_title" rows="3"></textarea>
										</td>
									</tr>
									<tr>
										<td>
										...
										<td>
											<textarea name="n_details" rows="15"></textarea>
										</td>
									</tr>
									<tr>
										<td>
										...
										<td>
											<input type="text" name="n_date" value="<?php echo date ("M d"); ?>"/>
										</td>
									</tr>
									<tr>
										<td>
										...
										<td>
											<input type="text" name="n_time" value="<?php echo date ("h:i A"); ?>"/>
										</td>
									</tr>
									<tr>
										<td>
