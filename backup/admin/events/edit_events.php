<?php
	...
	$sql = mysql_query ("select * from events where event_id = '$_GET[e_id]'");
	...
	<div class="container">
		...
		<div class="right">
			<div class="contentDiv">
				<div class="content">
					<form action="content/update_events.php" method="post">
					<fieldset>
						<legend>Edit events</legend>
								<table border="0" cellpadding="0" cellspacing="0">
									...
									<tr>
										...
										<td>
											<textarea name="e_details" rows="15"><?php echo $row['event_details']; ?></textarea>
										</td>
									</tr>
									<tr>
										<td>
